...
__USR_REGION__='IDF'																	# dependance{install},categorie{user},type{text},name{var}
__USR_COUNTRY__='FR'																	# dependance{install},categorie{user},type{text},name{var}
# _-___________________________________________________________________________________________[ ENV ]___________________________________________________________________________________________-_
__ENV_VPN__='8080'																		# dependance{install},categorie{env},type{text},name{var}
...
__NG_USER__='na'																	# dependance{install},categorie{web},type{text},name{var}
__NG_PASSWORD__='na'															# dependance{install},categorie{web},type{text},name{var}
...
__TM_PROXY__='transmission'																# dependance{install},categorie{pro},type{text},name{var}
__HW_PROXY__='hardware'																	# dependance{install},categorie{pro},type{text},name{var}
__DATA_COUCHPOTATO__='couchpotato'														# dependance{install},categorie{pro},type{text},name{var}
__DATA_HEADPHONES__='headphones'														# dependance{install},categorie{pro},type{text},name{var}
__DATA_LAZYLIBRARIAN__='lazylibrarian'													# dependance{install},categorie{pro},type{text},name{var}
__DATA_SICKBEARD__='sickbeard'															# dependance{install},categorie{pro},type{text},name{var}
__DATA_SABNZBD__='sabnzbd'																# dependance{install},categorie{pro},type{text},name{var}
__DATA_SUBSONIC__='subsonic'															# dependance{install},categorie{pro},type{text},name{var}
__DATA_GAMEZ__='gamez'																	# dependance{install},categorie{pro},type{text},name{var}
__DATA_WWW__='www'																		# dependance{install},categorie{pro},type{text},name{var}
__DATA_MEDIA__='media'																	# dependance{install},categorie{pro},type{text},name{var}
__DATA_PUBLIC__='public'																# dependance{install},categorie{pro},type{text},name{var}
__DATA_DOWNLOAD__='download'															# dependance{install},categorie{pro},type{text},name{var}
__DATA_MUSIC__='Music'																	# dependance{install},categorie{pro},type{text},name{var}
__DATA_TV__='TV'																		# dependance{install},categorie{pro},type{text},name{var}
__DATA_PICTURE__='Picture'																# dependance{install},categorie{pro},type{text},name{var}
__DATA_MOVIE__='Movie'																	# dependance{install},categorie{pro},type{text},name{var}
...
__ISO_NAME__='debian-11.6.0-amd64-netinst'											# dependance{install},categorie{iso},type{text},name{var}
